...
[env]
CLOUDFLARE_EMAIL = "$(op read op://Gopad/Cloudflare/username)"
CLOUDFLARE_API_KEY = "$(op read op://Gopad/Cloudflare/token)"

AWS_ACCESS_KEY_ID = "$(op read op://Gopad/Terraform/username)"
AWS_SECRET_ACCESS_KEY = "$(op read op://Gopad/Terraform/password)"
EOF
```
